...
contract OnchainNFT is ERC721URIStorage {
    ...
    constructor() ERC721("CRISYMONIE NFT", "CNFT") {
   ...
   '<text x="50%" y="40%" class="base" dominant-baseline="middle" text-anchor="middle">CRIPSYMONIE NFT</text>'
   '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">Symbol: CMT</text>'
 '</svg>'
        );
